...
from .views import (
    ...
    StaffShiftListCreateAPIView,
    StaffShiftRetrieveUpdateAPIView,
    StaffAttendanceListCreateAPIView,
    StaffAttendanceRetrieveAPIView)
...
urlpatterns = [
    ...
    path(
        'position/<int:pk>/',
        PositionRetrieveUpdateDestroyAPIView.as_view(),
        name='position-detail'),
    path(
        'staff-shift/',
        StaffShiftListCreateAPIView.as_view(),
        name='staff-shift-list-create'),
    path(
        'staff-shift/<int:pk>/',
        StaffShiftRetrieveUpdateAPIView.as_view(),
        name='staff-shift-detail'),
    path(
        'staff-attendance/',
        StaffAttendanceListCreateAPIView.as_view(),
        name='staff-attendance-list-create'),
    path(
        'staff-attendance/<int:pk>/',
        StaffAttendanceRetrieveAPIView.as_view(),
