...
from main_app.models import Staff, Shift, Position, StaffShift, StaffAttendance
...
class StaffRetrieveUpdateDestroyAPIView(
...
class PositionRetrieveUpdateDestroyAPIView(
        generics.RetrieveUpdateDestroyAPIView,
        LoginRequiredMixin):
    queryset = Position.objects.all()
    serializer_class = PositionSerializer
...
class StaffShiftRetrieveUpdateAPIView(
...
class StaffAttendanceListCreateAPIView(
